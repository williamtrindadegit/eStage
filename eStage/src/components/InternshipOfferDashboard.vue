    ...
    <section className="m-5 p-10 bg-gray-100 rounded-lg">
        ...
        <div className="bg-white mx-2 mt-4 mb-16 p-8 rounded-lg">
            <div className="grid grid-cols-1 md:flex justify-between">
                <div>
                    <h2 class="text-black font-semibold">Dernières <span class="text-red-600">offres</span> de stage
                    </h2>
            ...
            <div v-for="offre in computedOffers" :key="offre._id" class="mt-6 md:grid md:grid-cols-4 gap-0">
                ...
                <div class="text-black md:border-b-4 md:p-1 md:border-slate-300 text-lg flex items-center">{{
                offre?.province?.value }}</div>
                <div class="text-black md:border-b-4 md:p-1 md:border-slate-300 text-lg flex items-center">{{ new
