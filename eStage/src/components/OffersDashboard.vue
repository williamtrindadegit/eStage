<template>
  <div className="bg-blue-100 mx-2 my-16 p-8 rounded-lg">
    <div className=" flex justify-between">
      ...
      <button className="btn bg-teal-500 border-teal-500 text-white">Valider toutes les offres</button>
    </div>
    ...
    <div className="grid mt-6 grid-cols-4 gap-4" v-for="demande in demandes">
      <div className="flex">
        <div className="bg-red-600 p-3 w-12 rounded-lg">
      ...
      <div className="text-black text-xs flex items-center">{{ demande.ville }}</div>
