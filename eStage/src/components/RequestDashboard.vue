  ...
  <section className="m-5 p-10 bg-gray-100 rounded-lg">
    ...
    <div className="mt-6 md:grid md:grid-cols-4 gap-4" v-for="demande in demandes">
      ...
      <div className="text-xs flex justify-between items-center">
        ...
        <button @click="accepterDemande(demande)" className="hidden lg:block btn bg-emerald-200 border-emerald-200 text-emerald-600 font-light">Accepter</button>
        <button className="w-6">
          <router-link to="/zoomUser/{{ demande.id }}"></router-link>
        ...
        <button className="w-6">
          <router-link to="/editinternshiprequest/{{demande.id}}">
        ...
        <button @click="supprimerDemande(demande.id)" className="w-6">
