        ...
        <form class="max-w-3xl p-4" action="#">
            ...
            <div v-if="!formulaireAjout">
                <div class="border-l-8 border-slate-600 pl-2">
                    ...
                    <input type="text" name="enterprise" id="enterprise" class="hidden input input-bordered w-full bg-slate-50 border-gray-400 rounded p-2 text-slate-500" placeholder="" :value="formData.enterprise.name" />
                </div>
                <div class="flex justify-end mb-4">
                    <button class="btn mr-2 bg-transparent text-slate-600 border-gray-400 hover:bg-fuchsia-950 hover:text-white">Annuler</button>
                    <button class="btn bg-fuchsia-900 text-white hover:bg-fuchsia-950">
                    ...
                    <div class="col-span-2">
                        <label for="requiredSkills" class="form-control w-full">
                            <div class="border-l-8 border-slate-600 pl-2">
                                ...
                                <textarea name="requiredSkills" id="requiredSkills" class="w-full textarea textarea-bordered bg-slate-50 border-gray-400 rounded p-2 text-slate-500 h-24" placeholder=""></textarea>
                            </div>
                            <div class="label pl-5">
                                <span class="label-text-alt text-red-500">Error Message</span>
                            </div>
                ...
                <fieldset class="grid grid-cols-2 max-w-3xl mt-8">
                    ...
                    <div class="flex flex-col border-l-8 border-slate-600 pl-2 mt-4 col-span-2">
                        ...
                        <div class="flex mb-2">
                            ...
                            <label class="ml-4 text-slate-600" for="discretion">À discuter</label>
                        </div>
                        <div class="flex mb-2">
