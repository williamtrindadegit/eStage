            ...
            <div class="bg-white p-5">
                ...
                <fieldset class="grid grid-cols-2 max-w-3xl mt-8">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="address" class="form-control w-full max-w-xs">
                            <div class="border-l-8 border-slate-600 pl-2">
                                <div class="label pt-0">
                                    <span class="text-slate-600 font-bold">Adresse</span>
                                </div>
                                <input type="text" name="address" id="address" placeholder="" class="input w-full max-w-xs bg-slate-50 border-gray-400 rounded p-2 text-slate-500" />
                            </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="phone" class="form-control w-full max-w-xs">
                            <div class="border-l-8 border-slate-600 pl-2">
                                ...
                                <input type="tel" name="phone" id="phone" placeholder="" class="input w-full max-w-xs bg-slate-50 border-gray-400 rounded p-2 text-slate-500" />
                            </div>
                            <div class="label pl-5">
                                <span class="label-text-alt text-red-500">Error Message</span>
                            </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="city" class="form-control w-full max-w-xs">
                            <div class="border-l-8 border-slate-600 pl-2">
                                <div class="label pt-0">
                                    <span class="text-slate-600 font-bold">Ville</span>
                                </div>
                                <input type="tel" name="city" id="city" placeholder="" class="input w-full max-w-xs bg-slate-50 border-gray-400 rounded p-2 text-slate-500" />
                            </div>
                            <div class="label pl-5">
                                <span class="label-text-alt text-red-500">Error Message</span>
                            </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="email" class="form-control w-full max-w-xs">
                            <div class="border-l-8 border-slate-600 pl-2">
                                ...
                                <input type="email" name="email" id="email" placeholder="" class="input w-full max-w-xs bg-slate-50 border-gray-400 rounded p-2 text-slate-500" />
                            </div>
                            <div class="label pl-5">
                                <span class="label-text-alt text-red-500">Error Message</span>
                            </div>
                    ...
                    <div class="col-span-2">
                        <label for="province" class="form-control w-full max-w-xs">
                            <div class="border-l-8 border-slate-600 pl-2">
                                <div class="label pt-0">
                                    <span class="text-slate-600 font-bold">Province</span>
                                </div>
                                <select name="province" id="province" class="select select-bordered w-full max-w-xs bg-slate-50 border-gray-400 rounded p-2 text-slate-500">
                    ...
                    <div class="col-span-2">
                        <label for="postalCode" class="form-control w-full max-w-xs">
                            <div class="border-l-8 border-slate-600 pl-2">
                                <div class="label pt-0">
                                    <span class="text-slate-600 font-bold">Code postal</span>
                                </div>
                                <input type="email" name="postalCode" id="postalCode" placeholder="" class="input w-full max-w-xs bg-slate-50 border-gray-400 rounded p-2 text-slate-500" />
                            </div>
                            <div class="label pl-5">
                                <span class="label-text-alt text-red-500">Error Message</span>
                            </div>
